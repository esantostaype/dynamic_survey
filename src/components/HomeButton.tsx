...
export const HomeButton = () => {
  return (
    <Link className="bg-[rgba(255,255,255,0.2)] hover:bg-accent1 transition-all group rounded-full flex items-center justify-center fixed bottom-4 right-4 z-[999] size-12" href="/">
